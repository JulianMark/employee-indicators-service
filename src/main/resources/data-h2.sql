...
--Se modifica por empleado tipo 2
INSERT INTO EMPLOYEES (NAME, LASTNAME,ID_TYPE_EMPLOYEE, NICKNAME, PASSWORD)
VALUES ('DANIELA', 'SANZ', 2 , 'DSANZ', '123');
...
VALUES ((SELECT ID_EMPLOYEE FROM TEAM_EMPLOYEES WHERE ID = 1), 1, 3, 1, TO_DATE('2020/01/01 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
...
INSERT INTO DAILY_RECORDS (ID_EMPLOYEE_TEAM, ID_CAMPAIGN, PRODUCTIVE_HOURS, NON_PRODUCTIVE_HOURS, CREATE_DATE)
VALUES ((SELECT ID_EMPLOYEE FROM TEAM_EMPLOYEES WHERE ID = 2), 1, 5, 3, TO_DATE('2020/01/01 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
...
INSERT INTO DAILY_RECORDS (ID_EMPLOYEE_TEAM, ID_CAMPAIGN, PRODUCTIVE_HOURS, NON_PRODUCTIVE_HOURS, CREATE_DATE)
VALUES (1, 2, 3, 1, TO_DATE('2020/01/01 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO DAILY_RECORDS (ID_EMPLOYEE_TEAM, ID_CAMPAIGN, PRODUCTIVE_HOURS, NON_PRODUCTIVE_HOURS, CREATE_DATE)
VALUES (1, 2, 8, 1, TO_DATE('2020/01/01 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
